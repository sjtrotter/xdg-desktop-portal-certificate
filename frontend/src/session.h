...
#ifndef SMARTCARD_FRONTEND_SESSION_H
#define SMARTCARD_FRONTEND_SESSION_H
 ...
 *  /io/github/sjtrotter/portal/desktop/session/<sender>/<session_handle_token>, built
...
typedef struct SmartcardSession SmartcardSession;
...
SmartcardSession* smartcard_session_new(GDBusMethodInvocation* invocation,
...
SmartcardSession* smartcard_session_lookup(const char* session_handle, const char* sender,
                                           GError** error);
...
void smartcard_session_close(SmartcardSession* session, const char* reason);

#endif /* SMARTCARD_FRONTEND_SESSION_H */
